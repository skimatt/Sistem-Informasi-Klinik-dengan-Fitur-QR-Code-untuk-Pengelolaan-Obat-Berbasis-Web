<?php
// File: application/views/apoteker/data_obat/list.php

// Pastikan variabel $title, $user_nama, $user_role, dan $obat sudah dilewatkan dari controller Apoteker::data_obat()
?>
...
<head>
    ...
    <title><?php echo isset($title) ? html_escape($title) : 'Data Obat (Apoteker)'; ?> Apotek</title>
    <meta name="description" content="Melihat dan mengedit informasi obat untuk Apoteker." />
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="<?php echo site_url('data_obat/edit/' . $row->id_obat); ?>">
                                                                        <i class="ti ti-pencil me-1"></i> Edit Info
                                                                    </a>
                                                                    <a class="dropdown-item" href="<?php echo site_url('obat/qrcode/' . $row->id_obat); ?>" target="_blank">
                                                                        <i class="ti ti-qrcode me-1"></i> Lihat QR
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </td>
