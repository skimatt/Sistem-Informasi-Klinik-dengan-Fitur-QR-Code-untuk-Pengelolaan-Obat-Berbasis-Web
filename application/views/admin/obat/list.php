<?php
// File: application/views/admin/obat/list.php

// Pastikan variabel $title, $user_nama, $user_role, dan $obat sudah dilewatkan dari controller Admin::obat()
?>
...
<head>
    ...
    <title><?php echo isset($title) ? html_escape($title) : 'Data Obat'; ?> Apotek</title>
    <meta name="description" content="Manajemen Data Obat Aplikasi Apotek." />
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="<?php echo site_url('obat/add'); ?>" class="btn btn-primary mb-3"><i class="ti ti-plus me-1"></i> Tambah Obat Baru</a>

                                <div class="table-responsive text-nowrap">
                                    <table id="obatTable" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Nama Obat</th>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="<?php echo site_url('obat/edit/' . $row->id_obat); ?>">
                                                                        <i class="ti ti-pencil me-1"></i> Edit
                                                                    </a>
                                                                    <a class="dropdown-item" href="<?php echo site_url('obat/delete/' . $row->id_obat); ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus obat ini?');">
                                                                        <i class="ti ti-trash me-1"></i> Hapus
                                                                    </a>
                                                                    <a class="dropdown-item" href="<?php echo site_url('obat/qrcode/' . $row->id_obat); ?>">
                                                                        <i class="ti ti-qrcode me-1"></i> QR Code
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </td>
