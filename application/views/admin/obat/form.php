<?php
// File: application/views/admin/obat/form.php

// Pastikan variabel $title, $user_nama, $user_role, $obat (jika edit),
// $kategori_obat, dan $jenis_obat sudah dilewatkan dari controller Admin::obat_form()
?>
...
<head>
    ...
    <title><?php echo isset($title) ? html_escape($title) : 'Form Obat'; ?> Apotek</title>
    <meta name="description" content="Form Tambah/Edit Data Obat Aplikasi Apotek." />
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <?php
                                $action_url = isset($obat) ? 'obat/edit/' . $obat->id_obat : 'obat/add';
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="stok" name="stok" value="<?php echo set_value('stok', isset($obat) ? $obat->stok : ''); ?>" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <a href="<?php echo site_url('obat'); ?>" class="btn btn-secondary">Batal</a>
                                <?php echo form_close(); ?>
                            </div>
                        </div>
